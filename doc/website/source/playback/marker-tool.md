...
Drawings are stored per slide. Toggling the marker off or navigating to another slide does not erase them - when you come back to a slide, its drawings are restored. Use the "Clear marker" action in the toolbar to clear the drawings for the current slide.
